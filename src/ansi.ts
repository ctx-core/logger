...
function debug_ansi_a_(...arg_a:any[]) {
	return (
		use_ansi
...
function log_ansi_a_(...arg_a:any[]) {
	return (
		use_ansi
...
function info_ansi_a_(...arg_a:any[]) {
	return (
		use_ansi
...
function warn_ansi_a_(...arg_a:any[]) {
	return (
		use_ansi
...
function error_ansi_a_(...arg_a:any[]) {
	return (
		use_ansi
